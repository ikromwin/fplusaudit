export const galleryData = [
    {
        ...
        photos: Object.values(import.meta.glob("/src/assets/gallery/1/*.{jpg,jpeg,png,svg}", { eager: true })).map((m) => m.default),
    },
    {
        id: "2",
        en_US: {
            title: "",
            description: "In September 2024, a discussion was held with the faculty of Tashkent State University of Economics on the topic of international auditing standards.",
        },
        ru_RU: {
            title: "",
            description: "В сентябре 2024 года состоялась дискуссия с профессорско-преподавательским составом Ташкентского государственного экономического университета на тему международных стандартов аудита.",
        },
        uz_UZ: {
            title: "",
            description: "2024 yil sentyabr oyida Toshkent Davlat Iqtisodiyot universiteti professir o'qtuvchilari bilan auditning xalqaro standartlari bo'yicha suxbat o'tkazildi.",
        },
        photos: Object.values(import.meta.glob("/src/assets/gallery/2/*.{jpg,jpeg,png,svg}", { eager: true })).map((m) => m.default),
    },
    {
        id: "3",
        en_US: {
        ...
        photos: Object.values(import.meta.glob("/src/assets/gallery/3/*.{jpg,jpeg,png,svg}", { eager: true })).map((m) => m.default),
    },
    {
        id: "4",
        en_US: {
        ...
        photos: Object.values(import.meta.glob("/src/assets/gallery/4/*.{jpg,jpeg,png,svg}", { eager: true })).map((m) => m.default),
    },
    {
        id: "5",
        en_US: {
            title: "",
            description: "O'zbekiston auditorlar palatasi tomonidan 2023-yil 9-dekabr kuni 'O'zbekiston' mehmonxonasida bo'lib o'tadigan O'zbekiston Respublikasi buxgalter va auditor kuniga bag'ishlangan xalqaro ilmiy-amaliy konferensiya. Tantanali tadbirda 'eng yaxshi auditor-2024', 'eng yaxshi buxgalter-2024' va 'eng yaxshi ichki auditor-2024' unvonlari uchun auditorlik tashkilotimiz xodimlari  g'oliblar sifatida taqdirlash marosimi bo'lib o'tdi.",
        },
        ru_RU: {
            title: "",
            description: "Международная научно-практическая конференция, посвященная Дню бухгалтера и аудитора Республики Узбекистан, которую проводит Аудиторская палата Узбекистана 9 декабря 2023 года в отеле «Узбекистон». В ходе торжественного мероприятия состоялась церемония награждения сотрудников нашей аудиторской организации – победителей конкурсов «Лучший аудитор-2024», «Лучший бухгалтер-2024» и «Лучший внутренний аудитор-2024».",
        },
        uz_UZ: {
            title: "",
            description: "O'zbekiston auditorlar palatasi tomonidan 2023-yil 9-dekabr kuni 'O'zbekiston' mehmonxonasida bo'lib o'tadigan O'zbekiston Respublikasi buxgalter va auditor kuniga bag'ishlangan xalqaro ilmiy-amaliy konferensiya. Tantanali tadbirda 'eng yaxshi auditor-2024', 'eng yaxshi buxgalter-2024' va 'eng yaxshi ichki auditor-2024' unvonlari uchun auditorlik tashkilotimiz xodimlari  g'oliblar sifatida taqdirlash marosimi bo'lib o'tdi.",
        },
        photos: Object.values(import.meta.glob("/src/assets/gallery/5/*.{jpg,jpeg,png,svg}", { eager: true })).map((m) => m.default),
    }
];
